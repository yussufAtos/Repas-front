...
/***************************************************************************************************
 * Added this part of code to escape the exception in tests
 * The exception is : ' TypeError: undefined is not an object (evaluating 'getAnimationStyle(element, '').trim') '
 */
